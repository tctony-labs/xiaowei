...
已给桌面 Vite 增加与 Storybook 一致的 100ms 轮询。用户重启后确认窗口显示恢复正常，旧实例的 720 × 76 尺寸已更新为 800 × 71；Agent 未执行冷启动。固定全局快捷键已在 2026-09-18 获用户功能确认，见 [固定快捷键](2026-09-18-fixed-launcher-shortcuts.md)。原生失焦隐藏、拖动、屏幕定位和真实输入法仍待运行验收，事项保持实施中。
